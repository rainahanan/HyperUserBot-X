...
class Config((object)):
    ...
    UPSTREAM_REPO_URL = os.environ.get(
        "UPSTREAM_REPO_URL", "https://github.com/ahirearyan2/HyperUserBot-X.git"
    )
    ...
    # REQUIRED
    API_KEY = "--"
    OWNER_ID = "1424391949"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "UNKNOWN_MEMBER_69"
