...
async def _(event):
        ...
        await asyncio.sleep(2)
        await event.edit("😎Jaha matter bada hota hai😎. {} wahi khada hota hai😏".format(DEFAULTUSER,aryan))
        await asyncio.sleep(2)
        await event.edit("Tera baap hu madharchod😈. Naam yad rakhna😡. Tera baap {}. 🔥🔥🔥🔥🔥".format(DEFAULTUSER,aryan))
